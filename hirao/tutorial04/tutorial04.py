...
class HiddenMarkovModel():
   ...
   def train(self, filename: str, out_filename: str = "HMM.txt"):
   ...
   def load(self, filename: str = "HMM.txt"):
      assert os.path.exists(filename), f"{filename} does not exist."
      with open(filename, encoding='utf-8') as f:
         for line in f:
...
if __name__ == "__main__":
   ...
   Model.train("../../data/wiki-en-train.norm_pos")
   # Model.train("../../test/05-train-input.txt")
   Model.load()

   # test
   with open("../../data/wiki-en-test.norm", encoding='utf-8') as f:
